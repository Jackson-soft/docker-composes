...
docker exec -it mongo-configsvr0 sh -c "mongo --port 27019 < /scripts/configserver.js"

## Shard servers setup
docker exec -it mongodb-primary sh -c "mongo --port 27017 < /scripts/shard.js"

## Apply sharding configuration
sleep 15
docker exec -it mongos sh -c "mongo --port 27018 < /scripts/mongos.js"
